...
public class FileMapDbSingleClientTokenService implements ClientTokenServices {
    private final DB db;
    ...
    public FileMapDbSingleClientTokenService(String fileName) {
    ...
    public OAuth2AccessToken getAccessToken(OAuth2ProtectedResourceDetails resource, Authentication authentication) {
        String key = keyGenerator.extractKey(resource, null);
